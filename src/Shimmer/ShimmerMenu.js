      ...
      shimmerItems.push(
        ...
        >
          <div className="mx-2 items-center relative my-4">
            <div className="w-40 xl:w-32 h-32 bg-gray-300 rounded-md border border-gray-100" />
            <div
  ...
  return (
    <div className="container mx-auto mt-8">
      ...
      <div className="container flex justify-between m-4 border-b border-dashed border-gray-500 pb-4">
        <div className="w-1/2 bg-gray-300 h-10 rounded-lg animate-pulse" />
        <div className="w-1/4 bg-gray-300 h-10 rounded-lg animate-pulse ml-7" />
      </div>
